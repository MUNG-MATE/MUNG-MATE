...
GRANT CONNECT, RESOURCE TO mung;
...
ALTER TABLE "RESERVATION" ADD CONSTRAINT "PK_RS" PRIMARY KEY (
   "RS_NO"
);
...
ALTER TABLE "SERVICE TYPE" ADD CONSTRAINT "PK_SERVICE TYPE" PRIMARY KEY (
   "SERVICE_NO"
);
