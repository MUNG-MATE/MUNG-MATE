...
<body>
    ...
    <div class=content2>
        ...
        <div class="mainContent_inner">
          ...
          <section>
            <div>
              <img class="H-img" src="https://t1.daumcdn.net/thumb/R720x0/?fname=http://t1.daumcdn.net/brunch/service/user/4arX/image/2le10oKKJsTRCMHUjW7fj6uFXp4.jpg" alt="해온 프리미엄 배딩">
            </div>
            <div>
              <div>
                <h3> 노즈워크를 아시나요?</h3>
