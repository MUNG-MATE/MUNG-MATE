...
(function(w) {
    ...
    try {
        var links = ["https:\/\/mat.adpies.com\/mat\/init?oaid=7aeba8bbecf0938e6e3c204ecbe4f706\u0026landing=https%3A%2F%2Fastg.widerplanet.com%2Fdelivery%2Fwpp.php%3Fwpg%3Dadpies_rtb%26oaid%3D7aeba8bbecf0938e6e3c204ecbe4f706","https:\/\/cm.g.doubleclick.net\/pixel?google_nid=wider_planet\u0026google_cm\u0026google_ula=12153253,1695695915\u0026poaid=7aeba8bbecf0938e6e3c204ecbe4f706","https:\/\/cm-exchange.toast.com\/bi\/pixel?cm_pid=1107948209\u0026puid=7aeba8bbecf0938e6e3c204ecbe4f706\u0026toast_push"],
            len = links.length,
            i;
        for (i=0; i<len; i++) {
            doPair(links[i]);
...
(function() {
var ttd = new Image();
ttd.src = "https:\/\/match.adsrvr.org\/track\/cmf\/generic?ttd_pid=ven6wdk\u0026ttd_tpi=1\u0026ttd_puid=7aeba8bbecf0938e6e3c204ecbe4f706";
})();
/*]]>*/
...
(function(w) {
    try {
        ...
        if (wp_uid) {
            ...
            if (is_wp_uid) {
                identity.setCookie('_wp_uid', "2-7aeba8bbecf0938e6e3c204ecbe4f706-s1688483037.861714|windows_10|chrome-173xerp", 365);
                return;
            }
        }
